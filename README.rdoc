...
== A quick word about this branch

I'm updating my library to support OSC 1.1.  Don't be fooled by passing tests!  This branch will be in a state of upheaval until it's merged into master.
