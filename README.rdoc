...
[![Build Status](https://travis-ci.com/aberant/osc-ruby.svg?branch=master)](https://travis-ci.com/aberant/osc-ruby)
...
thx also to Toby Tripp, Brian McClain, Andreas Haller, James Hughes, and Rapofran
